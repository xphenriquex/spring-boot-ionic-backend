...
import com.cursospringboot.cursospringboot.dto.ProdutoDTO;
import com.cursospringboot.cursospringboot.resources.utils.URL;
import com.cursospringboot.cursospringboot.services.ProdutoService;
...
public class ProdutoResource {
            ...
            @RequestParam(value = "direction", defaultValue = "ASC")String direction)
    {
        ...
        Page<ProdutoDTO> listDto =
                list.map(obj -> new ProdutoDTO(obj));
